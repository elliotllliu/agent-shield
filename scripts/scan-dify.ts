...
let md = `# 🛡️ Agent Shield — Dify Plugins Security Report
...
**Scanner**: [Agent Shield](https://github.com/elliotllliu/agent-shield) v0.3.0
...
md += `2. Consider integrating Agent Shield into the dify-plugins CI pipeline\n`;
md += `3. Add \`.agent-shield.yml\` config to customize severity thresholds per plugin\n`;
md += `\n---\n\n*Generated by [Agent Shield](https://github.com/elliotllliu/agent-shield) v0.3.0*\n`;
