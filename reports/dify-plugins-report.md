...
| 🟡 Plugins with Medium Risk only | 64 | 13.0% |
| 🟢 Clean plugins (Low/None) | 423 | 85.8% |

**Total findings**: 960 (🔴 15 high, 🟡 205 medium, 🟢 740 low)
...
| bowenliang123/md_exporter/md_exporter | 0 | 6 | 6 | 1 | Python exec() with dynamic input |
...
| xiaobao_plugin/yinxiangnote/yingxiangnote | 65 | 1 | 1 | 1 | Python exec() with dynamic input |
...
#### xiaobao_plugin/yinxiangnote/yingxiangnote (Score: 65)
...
|--------|-------|--------|--------|-------------|
| clickzetta/clickzetta_lakehouse | 0 | 23 | 1 | [sql-injection] SQL query with f-string — SQL injection risk |
...
| # | Finding | Occurrences |
|---|---------|-------------|
| 1 | [privilege] No SKILL.md found — permission analysis skipped | 480 |
| 2 | [python-security] [weak-crypto] MD5 hash — cryptographically weak | 23 |
| 3 | [network-ssrf] Request to localhost — verify if intentional | 17 |
| 4 | [obfuscation] Hex-encoded string sequence | 13 |
| 5 | [sensitive-read] Accesses AWS credentials | 13 |
| 6 | [python-security] [weak-crypto] SHA1 hash — cryptographically weak | 13 |
| 7 | [python-security] [insecure-network] SSL verification disabled (verify=False) | 11 |
| 8 | [skill-risks] Financial execution: Direct money transfer capability | 10 |
| 9 | [tool-shadowing] Tool shadowing: Redirects from another tool to this one | 9 |
| 10 | [backdoor] Python exec() with dynamic input | 8 |
| 11 | [sensitive-read] Accesses Kubernetes config | 8 |
| 12 | [prompt-injection] Prompt injection: Instructs decoding of obfuscated payloads | 8 |
| 13 | [prompt-injection] Prompt injection: Claims elevated priority/privilege | 8 |
...
| 17 | [prompt-injection] Prompt injection: Urgency-based behavioral directive in description | 6 |
| 18 | [prompt-injection] Suspicious URL: Pipes download output to execution | 6 |
